...
if (isset($_POST["cadastro"])) {
  ...
  $nome = $_POST["lanche"];
  $valor = $_POST["valor"];
  $categoria = $_POST["flexRadioDefault"];
  $descricao = $_POST["ingredientes"];

  $sql = "INSERT INTO tab_produtos(nome,valor,descricao,id_categoria,img)
  VALUES ('$nome','$valor','$descricao','$categoria','$img')";
  if (mysqli_query($conn, $sql)) {
    echo json_encode("Cadastro efetuado !");
  } else {
        ...
        <div class="">
          <div class="">
            <div class="form_container mx-5">
              ...
              <div>
                <input type="text" class="form-control" placeholder="nome do lanche" name="lanche" id="lanche" />
              </div>
              <div>
              ...
              <div>
                <textarea class="form-control mt-3" placeholder="ingrediente" name="ingredientes" id="ingreditentes"></textarea>
              </div>

...
if (isset($_GET["cadastro"])) {
    ...
    if ($nome && $email && $senha && $telefone && $cpf && $acesso) {
  $sqlInsert ="INSERT INTO tab_cadastro(nome,email,senha,tell,cpf,id_acesso)
   VALUES('$nome','$email','$senha','$telefone','$cpf','$acesso')";
echo($sqlInsert);
      ...
      <div class="">
        <div class="">
          <div class="form_container mx-5">
            ...
            <div>
              <input type="text" class="form-control" placeholder="Numero de telefone" name="tell" id="numtell" />
            </div>
            <div>
            ...
            <div class="d-flex justify-content-between">
              ...
              <div class="btn_box">
                <button name="cadastro">
                <a class="text-white" href="./cadastro.php">ja tenho login</a>
                </button>
              </div>
            </div>
